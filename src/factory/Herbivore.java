...
public class Herbivore extends Animal {
    public Herbivore(String name, String gender, Isla isla, ExecutorService executor,AnimalFactory animalFactory) {
    ...
    public void eat(Animal otherAnimal) {
        ...
        if (this.huntingProbabilities.containsKey(otherAnimal.getName())) {
            ...
            System.out.println(this.name+isla.setUnicode(this.name)+" esta comiendo plantas");
        }
    }
